...
export default function ProductScreen() {
  ...
  if (!product) {
    return <Text style={{ flex: 1, textAlign: 'center', marginTop: 50 }}>Error loading product</Text>;
  }
    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.ratingRow}>
          <View style={{ flexDirection: 'row' }}>{renderStars(product.rating?.rate || 0)}</View>
        ...
        <TouchableOpacity style={styles.companyCard}>
          <Ionicons name="business-outline" size={28} color="#333" style={{ marginRight: 10 }} />
          <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  ratingRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 6 },
  ratingText: { fontSize: 13, marginLeft: 4, color: 'gray' },
  title: { fontSize: 22, fontWeight: 'bold', textAlign: 'center', marginBottom: 10 },
  description: { fontSize: 14, color: '#555', textAlign: 'center', marginBottom: 15, lineHeight: 20 },
  ...
  similarImage: { width: 80, height: 80, resizeMode: 'contain', marginBottom: 5 },
